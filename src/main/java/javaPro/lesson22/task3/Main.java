package javaPro.lesson22.task3;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Трёхзначное число, которое начинается на 2,
        // при этом не может быть больше 255
    ...
    public static void checkIP(String ip){
        String regEx1 = "([0-9]{1,2}|(0|1)[0-9]{2}|2[0-4][0-9]|25[0-5])";

        String regEx = regEx1 + "\\." + regEx1 + "\\." + regEx1 + "\\." + regEx1;
